    ...
    public class DemetriusProfile
    {
        ...
        public static class DemetriusContract
        {
            ...
            public static void DemetriusIntroduction()
            {
                ...
                profile.FarmerSkillLevel = Game1.player.foragingLevel.Value; // Player Skill Level

                // Build seasonal item responses
                int[][] SeasonalCollect = new int[][]
                {
                    new int[] { 257, 281, 404, 422 }, // Spring
                    new int[] { 257, 281, 404, 422 }, // Summer
                    new int[] { 257, 281, 404, 422 }, // Fall
                    new int[] { 257, 281, 404, 422 }  // Winter
                };
