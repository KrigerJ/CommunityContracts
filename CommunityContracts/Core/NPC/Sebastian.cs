    ...
    public class SebastianProfile
    {
        ...
        public static class SebastianContract
        {
            ...
            public static void SebastianIntroduction()
            {
                ...
                profile.FarmerSkillLevel = Game1.player.fishingLevel.Value; // Player Skill Level

                // Build seasonal item responses
                int[][] SeasonalCollect = new int[][]
                {
                    new int[] { 136, 143, 700, 702 }, // Spring
                    new int[] { 136, 138, 143, 144, 698, 700, 702 }, // Summer
                    new int[] { 136, 140, 143, 269, 700, 702 }, // Fall
                    new int[] { 136, 140, 143, 144, 269, 698, 700, 702, 707 }  // Winter
                };
