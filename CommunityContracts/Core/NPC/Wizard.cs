    ...
    public class WizardProfile
    {
        ...
        public static class WizardContract
        {
            ...
            public static void WizardIntroduction()
            {
                ...
                profile.FarmerSkillLevel = Game1.player.farmingLevel.Value; // Player Skill Level

                // Build seasonal item responses
                int[][] SeasonalCollect = new int[][]
                {
                    new int[] { 305, 422, 767, 768, 769 }, // Spring
	                new int[] { 305, 422, 767, 768, 769 }, // Summer
	                new int[] { 305, 422, 767, 768, 769 }, // Fall
	                new int[] { 305, 422, 767, 768, 769 }  // Winter
 			    };
