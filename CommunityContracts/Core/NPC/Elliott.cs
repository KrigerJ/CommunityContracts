    ...
    public class ElliottProfile
    {
        ...
        public static class ElliottContract
        {
            ...
            public static void ElliottIntroduction()
            {
                ...
                {
                    new int[] { 148, 267, 708 }, // Spring
                    new int[] { 128, 130, 146, 149, 150, 155, 267, 701, 708 }, // Summer
                    new int[] { 148, 150, 154, 155, 701, 705 }, // Fall
                    new int[] { 130, 146, 150, 151, 154, 705, 708 }  // Winter
                };
